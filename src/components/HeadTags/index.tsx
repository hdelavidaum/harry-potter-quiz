...
const HeadTags = () => {
    return (
        <Head>
            ...
            <meta property="og:description" content="Quiz of Harry Potter's World developed by Henrique Delavi Daum at 'Imersão Alura React + NextJS' and deployed with Vercel" />
            ...
            <meta property="twitter:description" content="Quiz of Harry Potter's World developed by Henrique Delavi Daum at 'Imersão Alura React + NextJS' and deployed with Vercel" />
